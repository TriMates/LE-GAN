...
from mdl3.stage1_teacher import *
# from mdl3.stage1_teacher import DT1
# from mdl3.stage1_teacher import GT1
from mdl3.model import Generator as GT2
from mdl3.model import Discriminator as DT2
...
parser.add_argument('--outf', default='./result/pre/teachernetv6.3_1130/output', help='folder to output images and model checkpoints')
parser.add_argument('--manualSeed', default=42, type=int, help='manual seed')
parser.add_argument('--classes', default='bedroom', help='comma separated list of classes for the lsun data set')
parser.add_argument('--ckpt', default='./result/pre/teachernetv6.3_1130/ckpt',help='ckpt file path')
