...
from models1.stage1_teacher import DT1
from models1.stage1_teacher import GT1_c16 as GT1
...
parser.add_argument('--outf', default='./result/pre/teachernetv6.2_1130/output', help='folder to output images and model checkpoints')
parser.add_argument('--manualSeed', default=42, type=int, help='manual seed')
parser.add_argument('--classes', default='bedroom', help='comma separated list of classes for the lsun data set')
parser.add_argument('--ckpt', default='./result/pre/teachernetv6.2_1130/ckpt',help='ckpt file path')
...
generator_criterion = GeneratorLoss(visual=100, adv=1, perc = 5, tv = 2e-8).cuda()
