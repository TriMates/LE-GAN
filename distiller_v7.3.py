...
parser.add_argument('--outf', default='./result/dis/teachernetv7.3_1215/output', help='folder to output images and model checkpoints')
parser.add_argument('--ckpt', default='./result/dis/teachernetv7.3_1215/ckpt',help='ckpt file path')
