...
parser.add_argument('--outf', default='./result/dis/teachernetv7.35re_1221/output', help='folder to output images and model checkpoints')
parser.add_argument('--ckpt', default='./result/dis/teachernetv7.35re_1221/ckpt',help='ckpt file path')
...
gs1sd = torch.load("./result/dis/teachernetv7.35_1215/ckpt/netG1_epoch_650.pth")
gs2sd = torch.load("./result/dis/teachernetv7.35_1215/ckpt/netG2_epoch_650.pth")
ds1sd = torch.load("./result/dis/teachernetv7.35_1215/ckpt/netD1_epoch_650.pth")
ds2sd = torch.load("./result/dis/teachernetv7.35_1215/ckpt/netD2_epoch_650.pth")
...
def pretrain():
    for epoch in range(650, opt.niter, 1):
    ...
    torch.save(gS1.state_dict(), opt.ckpt+'/netG1_Final4000.pth')
    torch.save(dS1.state_dict(), opt.ckpt+'/netD1_Final4000.pth')
    torch.save(gS2.state_dict(), opt.ckpt+'/netG2_Final4000.pth')
    torch.save(dS2.state_dict(), opt.ckpt+'/netD2_Final4000.pth')
