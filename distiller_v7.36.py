...
parser.add_argument('--outf', default='./result/dis/teachernetv7.36_1215/output', help='folder to output images and model checkpoints')
parser.add_argument('--ckpt', default='./result/dis/teachernetv7.36_1215/ckpt',help='ckpt file path')
...
def pretrain():
    for epoch in range(opt.niter):
        for i,data in enumerate(dl):
            ...
            DF2 = dS2(fake2)
            # del GFT1
            setGLoss(visual = 100, adv=1, perc=1)
